...
##4.i
#Yes, shark attacks occur as a Poission process. There is no obvious answer but more shark attacks
#are happening in US, Australia, SouthAfricsThat.
